const isGlobalEvent = new Set(["10", "11", "12", "13"]);
...
function createEventX(){
    ...
    */
    ...
    let msg = "#msg " + document.getElementById("#msg").value;
    ...
    getSelectedValue("#2d6vis", "-1");
    getSelectedValue("#3d6vis", "-1");
    getSelectedValue("#4d6vis", "-1");
